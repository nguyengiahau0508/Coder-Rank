...
export class AuthService {
	...
	async handleOAuthLogin(req: any, provider: string) {
		...
		return this.generateLoginResponse(user, req.ip);
	}
	...
	async generateLoginResponse(user: User, ip: string) {
	...
	async refreshToken(req: any, token: string) {
		try {
